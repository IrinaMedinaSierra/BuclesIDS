 ...
 * Ejercicio:
 *
 * Crea una aplicación para calcular los datos estadísticos de las edades de los alumnos de un centro educativo.
...
public class Ejercicio2_While {
    public static void main(String[] args) {
        ...
        while (edad>=0){
            ...
            edad=sc.nextInt(); //si se escribe un número negativo...se indica que no puede calcular ---se sale del bucle
            if(edad>=0){
                contadorEdad+=edad;
                contadorAlumnos++;
                if (edad>=18) {
        ...
        System.out.println("Estadistica del Alumnado: " +
